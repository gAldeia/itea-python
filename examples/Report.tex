...
\label{sec:Evolutionconvergence}%
                ...
                The algorithm took 130.93 seconds to
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{/tmp/pylatex-tmp.v1ygw_1b/fitness_convergence.pdf}%
\end{figure}
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{/tmp/pylatex-tmp.v1ygw_1b/pe.pdf}%
\end{figure}
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{/tmp/pylatex-tmp.v1ygw_1b/ig.pdf}%
\end{figure}
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{/tmp/pylatex-tmp.v1ygw_1b/shapley.pdf}%
\end{figure}
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{/tmp/pylatex-tmp.v1ygw_1b/normalized_partial_effects.pdf}%
\end{figure}
...
\begin{figure}[H]%
\centering%
\includegraphics[width=\textwidth]{/tmp/pylatex-tmp.v1ygw_1b/partial_effets_at_means.pdf}%
\end{figure}
