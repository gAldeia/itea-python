...
\label{sec:Evolutionconvergence}%
                ...
                The algorithm took 130.188 seconds to
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{/tmp/pylatex-tmp.crxm0l7k/fitness_convergence.pdf}%
\end{figure}
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{/tmp/pylatex-tmp.crxm0l7k/pe.pdf}%
\end{figure}
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{/tmp/pylatex-tmp.crxm0l7k/ig.pdf}%
\end{figure}
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{/tmp/pylatex-tmp.crxm0l7k/shapley.pdf}%
\end{figure}
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{/tmp/pylatex-tmp.crxm0l7k/normalized_partial_effects.pdf}%
\end{figure}
...
\begin{figure}[H]%
\centering%
\includegraphics[width=\textwidth]{/tmp/pylatex-tmp.crxm0l7k/partial_effets_at_means.pdf}%
\end{figure}
