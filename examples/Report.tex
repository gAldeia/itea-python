...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{/tmp/pylatex-tmp.yema9sqn/fitness_convergence.pdf}%
\end{figure}
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{/tmp/pylatex-tmp.yema9sqn/average_partial_effects.pdf}%
\end{figure}
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{/tmp/pylatex-tmp.yema9sqn/normalized_partial_effects.pdf}%
\end{figure}
...
\begin{figure}[H]%
\centering%
\includegraphics[width=\textwidth]{/tmp/pylatex-tmp.yema9sqn/partial_effets_at_means.pdf}%
\end{figure}
