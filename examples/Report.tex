...
\label{sec:Evolutionconvergence}%
                ...
                The algorithm took 76.86 seconds to
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{/tmp/pylatex-tmp.ipbc_flv/fitness_convergence.pdf}%
\end{figure}
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{/tmp/pylatex-tmp.ipbc_flv/pe.pdf}%
\end{figure}
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{/tmp/pylatex-tmp.ipbc_flv/ig.pdf}%
\end{figure}
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{/tmp/pylatex-tmp.ipbc_flv/shapley.pdf}%
\end{figure}
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{/tmp/pylatex-tmp.ipbc_flv/normalized_partial_effects.pdf}%
\end{figure}
...
\begin{figure}[H]%
\centering%
\includegraphics[width=\textwidth]{/tmp/pylatex-tmp.ipbc_flv/partial_effets_at_means.pdf}%
\end{figure}
